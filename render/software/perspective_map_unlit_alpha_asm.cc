...
static w8 last_alpha_accumulated;
                                              ...
                                              sw32 width)
{
  ...
  if (num_subdivisions)
  {
    ...
    looper1:
      ...
      skip_pixel_4:
        ...
        mov byte ptr [last_alpha_accumulated],bh
  ...
  {        
    ...
    else
    {
      ...
      register w16 texel = *( r1_software_texture_ptr + (left_s>>16) + ((left_t>>16) << r1_software_twidth_log2) );
