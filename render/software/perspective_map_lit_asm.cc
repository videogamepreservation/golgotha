                                      ...
                                      sw32 width)
{
  ...
  _asm
  {
    ...
    mov eax,dword ptr [esi]perspective_span.l
  ...
  if (num_subdivisions)
  {
    ...
    while (num_subdivisions)
    {
      ...
      done_compare:
        ...
        mov bh,byte ptr [last_bh2] //get the dither back into bh

        add ch,0 //clear the carry bit. clc is 2 cycles. dumb.
        ALIGN 16
    ...
    looper1:
        ...
        mov ax,word ptr [esi*2]  //first pixel is finished aroundhere
        add edx,dword ptr [dtdx_frac]
